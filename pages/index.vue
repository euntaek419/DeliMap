...
function makeMarkerInfowindow() {

  // 인포윈도우를 생성합니다
  markerInfowindow = new kakao.maps.InfoWindow({
    // position: iwPosition,
    content: message,
  });
...
<template>
  ...
  <div class="map_wrap">
    ...
    <div id="menu_wrap" class="bg_white">
      <div class="option">
        <div>
          키워드 : <input type="text" v-model="keyword" id="keyword" size="15" @keydown.enter="searchPlaces">
